...
func WebRPCSchemaHash() string {
	return "fa4600dfba302a5f8c43be7d70d4b0e1493bc800"
}

type EmailService interface {
	SendEmail(ctx context.Context, email string, name string, body string, price uint64, electricity float32, gas float32) (bool, error)
}
...
func (s *emailServiceServer) serveSendEmailJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.EmailService.SendEmail(ctx, reqContent.Arg0, reqContent.Arg1, reqContent.Arg2, reqContent.Arg3, reqContent.Arg4, reqContent.Arg5)
	}()
	respContent := struct {
